...
private static final String CONFIG_PATH = "/config.ser";
        ...
        if (file.exists()) {
            ...
            try {
                ...
                if (configuration.getConfig_type() != null) {
                    String configType = EncodeHelperUtil.decodeInstall(configuration.getConfig_type());
                ...
                if (configuration.getConfig_host() != null) {
                    configuration.setConfig_host(EncodeHelperUtil.decodeInstall(configuration.getConfig_host()));
                }
                if (configuration.getConfig_port() != null) {
                    configuration.setConfig_port(EncodeHelperUtil.decodeInstall(configuration.getConfig_port()));
                }
                if (configuration.getConfig_username() != null) {
                    configuration.setConfig_username(EncodeHelperUtil.decodeInstall(configuration.getConfig_username()));
                }
                if (configuration.getConfig_password() != null) {
                    configuration.setConfig_password(EncodeHelperUtil.decodeInstall(configuration.getConfig_password()));
                }
